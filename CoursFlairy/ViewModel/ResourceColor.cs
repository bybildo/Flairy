...
namespace CoursFlairy.ViewModel
{
    static class ResourceColor
    {
        ...
        public static readonly SolidColorBrush EconomColor = (SolidColorBrush)Application.Current.Resources["EconomColor"];
        public static readonly SolidColorBrush BusinessColor = (SolidColorBrush)Application.Current.Resources["BussinessColor"];
        public static readonly SolidColorBrush FirstColor = (SolidColorBrush)Application.Current.Resources["FirstColor"];
